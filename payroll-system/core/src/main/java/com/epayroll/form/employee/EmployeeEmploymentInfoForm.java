 ...
 * @author Rajul Tiwari
 */
public class EmployeeEmploymentInfoForm {

	@NotBlank
	private String employeeId;
	private Long workersCompCodeId;
	// @NotBlank
	// @Email
	...
	public Long getWorkersCompCodeId() {
		return workersCompCodeId;
	}

	public void setWorkersCompCodeId(Long workersCompCodeId) {
	...
	public String toString() {
		...
		builder.append(", workersCompCodeId=");
		builder.append(workersCompCodeId);
