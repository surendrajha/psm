...
<%-- 	</c:if> --%>
	...
	<form name="f" action="<c:url value='/check_login' />" method='POST'>
		<p>
			...
			<a href="${pageContext.request.contextPath}/showForgotUserIdStep1">Forgot Username?</a>
		</p>
		<br />
		<p>
			<label>Password</label>&nbsp;<input type='password' name='password'><br>
			<a href="${pageContext.request.contextPath}/showForgotPasswordStep1">Forgot Password?</a>
		</p>
		<p>
			<input value="Sign In" type="submit" name="submit"> <input value="Clear" type="reset"
				name="reset">
		</p>
	</form>
</div>
