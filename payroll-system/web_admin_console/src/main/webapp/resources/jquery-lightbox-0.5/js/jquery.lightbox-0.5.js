...
(function($) {
	...
	$.fn.lightBox = function(settings) {
				...
				.extend(
						{
							...
							overlayBgColor : '#000', // (string) Background
							// color to overlay;
							// inform a hexadecimal value like:
							// #RRGGBB. Where RR, GG, and BB are the
							// hexadecimal values for the red,
							// green, and blue values of the color.
							overlayOpacity : 0.8, // (integer) Opacity value
							// to overlay;
							// inform: 0.X. Where X are number from 0 to
							// 9
							// Configuration related to navigation
							fixedNavigation : false, // (boolean) Boolean
							// that informs if the
							// navigation (next and prev button)
							// will be fixed or not in the
							// interface.
							// Configuration related to images
							imageLoading : '/PayrollSystemAdminConsole/resources/jquery-lightbox-0.5/images/lightbox-ico-loading.gif', // (string)
							// Path
							// and the name
							// of the
							// loading icon
							imageBtnPrev : '/PayrollSystemAdminConsole/resources/jquery-lightbox-0.5/images/lightbox-btn-prev.gif', // (string)
							// Path
							// and
							// the
							// name
							...
							// button
							// image
							imageBtnNext : '/PayrollSystemAdminConsole/resources/jquery-lightbox-0.5/images/lightbox-btn-next.gif', // (string)
							// Path
							// and
							// the name of the
							// next button image
							imageBtnClose : '/PayrollSystemAdminConsole/resources/jquery-lightbox-0.5/images/lightbox-btn-close.gif', // (string)
							// Path
							// and the name
							// of the close
							// btn
							imageBlank : '/PayrollSystemAdminConsole/resources/jquery-lightbox-0.5/images/lightbox-blank.gif', // (string)
							// Path
							// and
							// the
							// name of a blank image
							// (one pixel)
							// Configuration related to container image box
							containerBorderSize : 10, // (integer) If you
							// adjust the padding
							// in the CSS for the container,
							// #lightbox-container-image-box, you
							// will need to update this value
							containerResizeSpeed : 400, // (integer) Specify the
							// resize duration
							// of container image. These number are
							// miliseconds. 400 is default.
							// Configuration related to texts in caption. For
							// example: Image 2
							// of 8. You can alter either "Image" and "of"
							// texts.
							txtImage : 'Image', // (string) Specify text "Image"
							txtOf : 'of', // (string) Specify text "of"
							// Configuration related to keyboard navigation
							keyToClose : 'c', // (string) (c = close) Letter
							// to close the
							// jQuery lightBox interface. Beyond this
							// letter, the letter X and the SCAPE key is
							// used to.
							keyToPrev : 'p', // (string) (p = previous)
							// Letter to show the
							// previous image
							keyToNext : 'n', // (string) (n = next) Letter to
							// show the next
							// image.
		...
		var jQueryMatchedObj = this; // This, in this context, refer to
		// jQuery object
		/**
		...
		function _initialize() {
			...
			// object (link) which the user have
			// clicked
		 ...
		 * 
		 * @param object
		 *            objClicked The object (link) whick the user have clicked
		 * @param object
		 *            jQueryMatchedObj The jQuery object with all elements
		 *            matched
		 */
		function _start(objClicked, jQueryMatchedObj) {
			...
			if (jQueryMatchedObj.length == 1) {
				...
				// atributes, inside the Array that storage the images
				// references
		 ...
		 * 
		 * The HTML markup will be like that: <div id="jquery-overlay"></div>
		 * <div id="jquery-lightbox"> <div id="lightbox-container-image-box">
		 * <div id="lightbox-container-image"> <img src="../fotos/XX.jpg"
		 * id="lightbox-image"> <div id="lightbox-nav"> <a href="#"
		 * id="lightbox-nav-btnPrev"></a> <a href="#"
		 * id="lightbox-nav-btnNext"></a> </div> <div id="lightbox-loading"> <a
		 * href="#" id="lightbox-loading-link"> <img
		 * src="../images/lightbox-ico-loading.gif"> </a> </div> </div> </div>
		 * <div id="lightbox-container-image-data-box"> <div
		 * id="lightbox-container-image-data"> <div id="lightbox-image-details">
		 * <span id="lightbox-image-details-caption"></span> <span
		 * id="lightbox-image-details-currentNumber"></span> </div> <div
		 * id="lightbox-secNav"> <a href="#" id="lightbox-secNav-btnClose"> <img
		 * src="../images/lightbox-btn-close.gif"> </a> </div> </div> </div>
		 * </div>
		 * 
		 */
		 ...
		 * 
		 * @param integer
		 *            intImageWidth The image�s width that will be showed
		 * @param integer
		 *            intImageHeight The image�s height that will be showed
		 */
		function _resize_container_image_box(intImageWidth, intImageHeight) {
			...
			var intWidth = (intImageWidth + (settings.containerBorderSize * 2)); // Plus
			// the
			// image�s
			// width
			// and
			...
			// padding
			// value
			var intHeight = (intImageHeight + (settings.containerBorderSize * 2)); // Plus
			// the
			// image�s
			// height
			// and
