...
<div class="signupsection1">
	...
	<p style="margin: 0px 0px 5px 0px; text-align: left;">
		<b>Enter Email and Dob then click Next </b>
	</p>
	<hr>
	<form:form commandName="forgotUserIdStep1Form"
		...
		<p>
			<label>Dob</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<form:input path='dob' value='MM/dd/yyyy' /> <form:errors path="dob" class="validation-error"></form:errors>
